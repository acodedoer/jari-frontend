...
const Loading = () =>{
    return(
        <div class="loading animated-load">
            <svg height="360" width="540" class="logo" >
                ...
                <rect transform="matrix(0.70710678,0.70710678,-0.70710678,0.70710678,0,0)" ry="29.6" height="59.2" width="304" stroke="#4b67a1" stroke-dasharray="none" stroke-miterlimit="4" y="-93.24" x="166.2" stroke-width="9.6" fill="#f2f6fd"/>

                <rect  transform="matrix(-0.70710678,0.70710678,-0.70710678,-0.70710678,0,0)" ry="29.6" height="59.2" width="304" stroke="#4b67a1" stroke-dasharray="none" stroke-miterlimit="4" y="-347.8" x="-215.64" stroke-width="9.6" fill="#f2f6fd"/>
